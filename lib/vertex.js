...
export async function chat(messages) {
    ...
    const policy = {
        ...
        parts: [{ text: [
            ...
            "Jika pengguna menyinggung 'saat ini', 'terkini', 'populer sekarang', atau hal sejenis yang bergantung pada waktu, anggap time-sensitive dan lakukan pencarian ringkas sebelum menjawab.",
        ].join(' ')}]
    }
    ...
    const body = {
        ...
        contents,
        ...(systemParts.length ? { systemInstruction: { role: "system", parts: [...systemParts, policy.parts[0]] } } : { systemInstruction: policy }),
        tools: [ { googleSearch: {} } ]
    };
