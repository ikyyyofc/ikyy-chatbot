...
export async function chat(messages) {
  ...
  const toolInstruction = {
    ...
    content: [
      ...
      '- Skip tools for greetings or non-factual chit-chat; keep it concise without update notes.',
      '- Only include URLs and a note like "Diperbarui per: <timestamp> (<TZ>)" when you actually used realtime_info or when stating time-sensitive external facts.'
    ].join(' ')
  }
